...
export default function Stage1Results({ data }: Stage1ResultsProps) {
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-2">Stage 1: Generated Specifications</h2>
      <p className="text-gray-600 mb-8">Product specifications generated by the system</p>
